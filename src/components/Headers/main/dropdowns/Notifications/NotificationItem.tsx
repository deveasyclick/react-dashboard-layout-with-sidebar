  ...
  <a
    ...
    <div className="flex-shrink-0">
      <img
        ...
        alt={avatarAlt}
      />
      <div className={`flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 rounded-full border border-white dark:border-gray-700 ${badgeColorClasses[badgeColor]}`}>
