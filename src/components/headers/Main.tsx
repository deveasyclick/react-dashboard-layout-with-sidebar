...
const NotificationsDropdown = ({
  ...
  showNotifications && (
    <div
      className="overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700 rounded-xl absolute right-0 top-4"
...
const AppsDropdown = ({ showApps }: { showApps: boolean }) =>
  showApps && (
    <div
      className="overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
      id="apps-dropdown">
      <div className="block py-2 px-4 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-600 dark:text-gray-300">
        Apps
      </div>
...
const UserMenuDropdown = ({ showUserMenu }: { showUserMenu: boolean }) =>
  showUserMenu && (
    <div
      className="z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
      id="dropdown">
...
const MainHeader = () => {
  const [showApps, setShowApps] = useToggleState(false);
  const [showNotifications, setShowNotifications] = useToggleState(false);
  const [showUserMenu, setShowUserMenu] = useToggleState(false);
    ...
    <nav className="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
      <div className="flex flex-wrap justify-between items-center">
        ...
        <section className="flex items-center lg:order-2">
          ...
          <UserMenuDropdown showUserMenu={showUserMenu} />
        </section>
      </div>
    </nav>
  );
